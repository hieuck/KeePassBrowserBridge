...
<style scoped>
.status-bar { display: flex; align-items: center; gap: var(--space-2); padding: var(--space-1) var(--space-3); border-top: 1px solid var(--color-border); background: var(--color-surface); font-size: var(--text-xs); color: var(--color-text-secondary); }
...
.status-bar__lock-btn--unlock { color: var(--color-danger); }
.status-bar__lock-btn--unlock:hover { background: var(--color-danger-subtle); }
.status-bar__status { flex: 1; text-align: center; font-size: var(--text-xs); }
...
.status-bar__theme-btn { background: transparent; border: none; width: 24px; height: 24px; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; color: var(--color-text-secondary); border-radius: var(--radius-sm); transition: background var(--transition-fast), color var(--transition-fast); }
