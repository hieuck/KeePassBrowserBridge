...
When no matching login exists and the page contains entered credentials, clicking `K` shows a Save prompt. Confirming it creates a new KeePass entry through the local bridge.
