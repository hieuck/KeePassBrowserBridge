...
- Reject create/get complete responses, including pre-serialized response JSON, that omit required WebAuthn response fields before completing the browser WebAuthn request.
