...
- Reject create/get complete responses, including pre-serialized response JSON, that omit required WebAuthn response fields or carry mismatched serialized credential ID fields before completing the browser WebAuthn request.
