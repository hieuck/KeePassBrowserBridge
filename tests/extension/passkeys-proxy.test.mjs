...
const mismatchedCompleteRpCalls = [];
const mismatchedCompleteRpHandlers = api.createBridgeRequestHandlers({
  bridgeCall: async (method, payload) => {
    mismatchedCompleteRpCalls.push([method, payload]);
    if (method === 'passkeys.get.begin') {
      return {
        WebAuthnRequestId: payload.WebAuthnRequestId,
        RpId: payload.RpId,
...
await assert.rejects(
  () => mismatchedCompleteRpHandlers.onGetRequest({
    requestId: 88,
    requestDetailsJson: JSON.stringify({
      rpId: 'example.com',
      challenge: 'MDEyMzQ1Njc4OWFiY2RlZg'
...
assert.deepEqual(plain(mismatchedCompleteRpCalls.map(([method, payload]) => [method, payload.WebAuthnRequestId, payload.CredentialId || ''])), [
  ['passkeys.get.begin', '88', ''],
  ['passkeys.get.complete', '88', 'Y3JlZC0x'],
  ['passkeys.cancel', '88', '']
...
await api.completeCreateSuccess(chromeApi, 51, JSON.stringify({
  id: 'Y3JlZC01MQ',
  rawId: 'Y3JlZC1ldmls',
  type: 'public-key',
  response: {
...
await api.completeGetSuccess(chromeApi, 52, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC01Mg',
    rawId: 'Y3JlZC1ldmls',
    type: 'public-key',
...
await api.completeCreateSuccess(chromeApi, 59, {
  Credential: { CredentialId: 'not@base64url' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  AttestationObject: 'YXR0ZXN0YXRpb24'
});
await api.completeGetSuccess(chromeApi, 60, {
  Assertion: {
    CredentialId: 'Y3JlZC02MA',
    AuthenticatorData: 'YXV0aC1kYXRh',
    ClientDataJson: 'Y2xpZW50LWdldA',
    Signature: 'not@base64url'
  }
});
await api.completeCreateSuccess(chromeApi, 61, {
  Credential: { CredentialId: 'Y3JlZC02MQ' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  AttestationObject: 'YXR0ZXN0YXRpb24',
  AuthenticatorData: 'not@base64url'
});
await api.completeGetSuccess(chromeApi, 62, {
  Assertion: {
    CredentialId: 'Y3JlZC02Mg',
    AuthenticatorData: 'YXV0aC1kYXRh',
    ClientDataJson: 'Y2xpZW50LWdldA',
    Signature: 'c2lnbmF0dXJl',
...
await api.completeCreateSuccess(chromeApi, 63, JSON.stringify({
  id: 'Y3JlZC02Mw',
  rawId: 'Y3JlZC02Mw',
  type: 'public-key',
  response: {
...
await api.completeGetSuccess(chromeApi, 64, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC02NA',
    rawId: 'Y3JlZC02NA',
    type: 'public-key',
...
await api.completeCreateSuccess(chromeApi, 66, {
  Credential: { CredentialId: 'Y3JlZC02Ng' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  AttestationObject: 'YXR0ZXN0YXRpb24',
  AuthenticatorAttachment: 'platform'
});
await api.completeGetSuccess(chromeApi, 67, {
  AuthenticatorAttachment: 'platform',
  Assertion: {
    CredentialId: 'Y3JlZC02Nw',
    AuthenticatorData: 'YXV0aC1kYXRh',
    ClientDataJson: 'Y2xpZW50LWdldA',
    Signature: 'c2lnbmF0dXJl'
  }
});
await api.completeCreateSuccess(chromeApi, 68, JSON.stringify({
  id: 'Y3JlZC02OA',
  rawId: 'Y3JlZC02OA',
  type: 'public-key',
  authenticatorAttachment: 'platform',
...
await api.completeGetSuccess(chromeApi, 69, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC02OQ',
    rawId: 'Y3JlZC02OQ',
    type: 'public-key',
...
await api.completeCreateSuccess(chromeApi, 70, {
  Credential: { CredentialId: 'Y3JlZC03MA' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  AttestationObject: 'YXR0ZXN0YXRpb24',
  ClientExtensionResults: {
    CredProps: {
...
await api.completeGetSuccess(chromeApi, 71, {
  Assertion: {
    CredentialId: 'Y3JlZC03MQ',
    AuthenticatorData: 'YXV0aC1kYXRh',
    ClientDataJson: 'Y2xpZW50LWdldA',
    Signature: 'c2lnbmF0dXJl'
  },
...
await api.completeCreateSuccess(chromeApi, 72, JSON.stringify({
  id: 'Y3JlZC03Mg',
  rawId: 'Y3JlZC03Mg',
  type: 'public-key',
  response: {
...
await api.completeGetSuccess(chromeApi, 73, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC03Mw',
    rawId: 'Y3JlZC03Mw',
    type: 'public-key',
...
await api.completeCreateSuccess(chromeApi, 78, {
  Credential: { CredentialId: 'Y3JlZC03OA' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  AttestationObject: 'YXR0ZXN0YXRpb24',
  ClientExtensionResults: {
    CredProps: {
...
await api.completeGetSuccess(chromeApi, 79, {
  Assertion: {
...
await api.completeCreateSuccess(chromeApi, 80, JSON.stringify({
  id: 'Y3JlZC04MA',
  rawId: 'Y3JlZC04MA',
  type: 'public-key',
  response: {
...
await api.completeGetSuccess(chromeApi, 81, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC04MQ',
    rawId: 'Y3JlZC04MQ',
    type: 'public-key',
...
await api.completeCreateSuccess(chromeApi, 82, {
  Credential: { CredentialId: 'Y3JlZC04Mg' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  AttestationObject: 'YXR0ZXN0YXRpb24',
  ClientExtensionResults: {},
  clientExtensionResults: {
...
await api.completeGetSuccess(chromeApi, 83, {
  Assertion: {
    CredentialId: 'Y3JlZC04Mw',
    AuthenticatorData: 'YXV0aC1kYXRh',
    ClientDataJson: 'Y2xpZW50LWdldA',
    Signature: 'c2lnbmF0dXJl'
  },
...
await api.completeCreateSuccess(chromeApi, 84, JSON.stringify({
  id: 'Y3JlZC04NA',
  rawId: 'Y3JlZC04NA',
  type: 'public-key',
  response: {
...
await api.completeGetSuccess(chromeApi, 85, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC04NQ',
    rawId: 'Y3JlZC04NQ',
    type: 'public-key',
...
await api.completeCreateSuccess(chromeApi, 90, {
  Credential: { CredentialId: 'Y3JlZC05MA' },
  ClientDataJson: 'Y2xpZW50LWNyZWF0ZQ',
  clientDataJSON: 'not@base64url',
  AttestationObject: 'YXR0ZXN0YXRpb24'
});
await api.completeGetSuccess(chromeApi, 91, {
  Assertion: {
    CredentialId: 'Y3JlZC05MQ',
    AuthenticatorData: 'YXV0aC1kYXRh',
    authenticatorData: 'not@base64url',
    ClientDataJson: 'Y2xpZW50LWdldA',
    Signature: 'c2lnbmF0dXJl'
...
await api.completeCreateSuccess(chromeApi, 92, JSON.stringify({
  id: 'Y3JlZC05Mg',
  rawId: 'Y3JlZC05Mg',
  type: 'public-key',
  response: {
...
await api.completeGetSuccess(chromeApi, 93, {
  responseJson: JSON.stringify({
    id: 'Y3JlZC05Mw',
    rawId: 'Y3JlZC05Mw',
    type: 'public-key',
...
assert.deepEqual(plain(calls[8]), [
  'create',
  {
    requestId: 51,
    error: {
...
assert.deepEqual(plain(calls[16]), [
  'create',
  {
    requestId: 59,
    error: {
...
assert.deepEqual(plain(calls[17]), [
  'get',
  {
    requestId: 60,
    error: {
...
assert.deepEqual(plain(calls[18]), [
  'create',
  {
    requestId: 61,
    error: {
...
assert.deepEqual(plain(calls[19]), [
  'get',
  {
    requestId: 62,
    error: {
...
assert.deepEqual(plain(calls[20]), [
  'create',
  {
    requestId: 63,
    error: {
...
assert.deepEqual(plain(calls[21]), [
  'get',
  {
    requestId: 64,
    error: {
...
assert.deepEqual(plain(calls[23]), [
  'create',
  {
    requestId: 66,
    error: {
...
assert.deepEqual(plain(calls[24]), [
  'get',
  {
    requestId: 67,
    error: {
...
assert.deepEqual(plain(calls[25]), [
  'create',
  {
    requestId: 68,
    error: {
...
assert.deepEqual(plain(calls[26]), [
  'get',
  {
    requestId: 69,
    error: {
...
assert.deepEqual(plain(calls[27]), [
  'create',
  {
    requestId: 70,
    error: {
...
assert.deepEqual(plain(calls[28]), [
  'get',
  {
    requestId: 71,
    error: {
...
assert.deepEqual(plain(calls[29]), [
  'create',
  {
    requestId: 72,
    error: {
...
assert.deepEqual(plain(calls[30]), [
  'get',
  {
    requestId: 73,
    error: {
...
assert.deepEqual(plain(calls[35]), [
  'create',
  {
    requestId: 78,
    error: {
...
assert.deepEqual(plain(calls[36]), [
  'get',
  {
    requestId: 79,
    error: {
...
assert.deepEqual(plain(calls[37]), [
  'create',
  {
    requestId: 80,
    error: {
...
assert.deepEqual(plain(calls[38]), [
  'get',
  {
    requestId: 81,
    error: {
...
assert.deepEqual(plain(calls[39]), [
  'create',
  {
    requestId: 82,
    error: {
...
assert.deepEqual(plain(calls[40]), [
  'get',
  {
    requestId: 83,
    error: {
...
assert.deepEqual(plain(calls[41]), [
  'create',
  {
    requestId: 84,
    error: {
...
assert.deepEqual(plain(calls[42]), [
  'get',
  {
    requestId: 85,
    error: {
...
assert.deepEqual(plain(calls[47]), [
  'create',
  {
    requestId: 90,
    error: {
...
assert.deepEqual(plain(calls[48]), [
  'get',
  {
    requestId: 91,
    error: {
...
assert.deepEqual(plain(calls[49]), [
  'create',
  {
    requestId: 92,
    error: {
...
assert.deepEqual(plain(calls[50]), [
  'get',
  {
    requestId: 93,
    error: {
